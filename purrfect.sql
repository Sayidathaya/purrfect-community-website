-- Purrfect Community full schema + seed
-- Generated from the original flat-site schema with MVC auth additions.
...
VALUES ('admin', '$2y$10$S9z1dOrFRKUlMbioyOcmNeQgGUDoMh9Uanc2xwOvZWdiizJ3DnKZ6', 'Administrator');
-- MySQL schema for Purrfect Community
-- Run: SOURCE purrfect.sql;
